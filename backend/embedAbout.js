...
function cleanCodeForRAG(rawCodeContent) {
    ...
    // Remove component function definitions (e.g., const About = () => {)
...
async function embedAbout() {
    try {
        ...
        const rawAboutContent = fs.readFileSync(aboutPath, "utf-8");

        console.log("Cleaning and Embedding About page content...");

        // Apply the cleaning function here!
        const cleanedContent = cleanCodeForRAG(rawAboutContent);
