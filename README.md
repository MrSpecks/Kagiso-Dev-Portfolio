...
The portfolio features a sophisticated **Retrieval-Augmented Generation (RAG) agent** that intelligently answers questions about my work, projects, and expertise—demonstrating not just what I've built, but how I think about complex AI systems.
