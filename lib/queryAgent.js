...
// 🎯 TARGET MODEL: Jina-Embeddings-v3-small-en (384 dimensions)
// Note: This model name is correct for the small, fast, 384-dimension vector.
...
// --- CONSTANTS ---
// Dimension remains 384, matching your existing Supabase schema
...
    } else {  
        throw new Error("Invalid embedding response from Jina AI (wrong structure or dimension).");  
    }
